...
# Loading the dataset.
iris_df = pd.read_csv("D:\Sublime\iris-species.csv")
...
images = ['D:\Sublime\Iris_Setosa.jpg', 'D:\Sublime\iris_virginica.jpg', 'D:\Sublime\iris_versicolor.jpg']
...
if st.button("Predict"):
  ...
  spec_type=st.write("Species predicted:", species_type)
  st.write("Accuracy score of this model is:", score)

  if spec_type == 'Iris-setosa':
    st.image(Image.open(images[0]))
  elif spec_type == 'Iris-virginica':
    st.image(Image.open(images[1]))
  elif spec_type == 'Iris-versicolor':
    st.image(Image.open(images[2]))